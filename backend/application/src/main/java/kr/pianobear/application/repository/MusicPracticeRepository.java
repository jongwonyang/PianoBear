...
public interface MusicPracticeRepository extends JpaRepository<MusicPractice, Integer> {
    Optional<MusicPractice> findByMusicAndMemberIdAndPracticeDate(Music music, String memberId, LocalDate practiceDate);
    ...
    List<MusicPractice> findAllByMemberIdAndPracticeDateBetween(String memberId, LocalDate startDate, LocalDate endDate);
