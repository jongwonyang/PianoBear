...
//        when(memberRepository.existsById(dto.getEmail())).thenReturn(false);
...
//        verify(memberRepository).existsById(dto.getEmail());
...
//        verify(memberRepository).existsById(dto.getId());
//        verify(memberRepository, never()).existsById(dto.getEmail());
...
//
//        when(memberRepository.existsById(dto.getId())).thenReturn(false);
//        when(memberRepository.existsById(dto.getEmail())).thenReturn(true);
//
//        DuplicateKeyException exception = assertThrows(DuplicateKeyException.class, () -> {
//            authService.register(dto, null);
//        });
