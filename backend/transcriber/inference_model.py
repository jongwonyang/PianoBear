...
from mt3 import models, network, vocabularies, preprocessors, spectrograms, metrics_utils
...
class InferenceModel(object):
    ...
    def __init__(self, checkpoint_path, model_type='mt3'):
        ...
        gin_files = ['mt3/mt3/gin/model.gin', f'mt3/mt3/gin/{model_type}.gin']
        ...
        self.codec = vocabularies.build_codec(vocab_config=vocabularies.VocabularyConfig(num_velocity_bins=num_velocity_bins))
