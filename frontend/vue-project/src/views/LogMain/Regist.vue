        ...
        <div class="regist-box">
            ...
            <div class="input-box">
                <md-outlined-text-field label="아이디" type="text" placeholder="영문+숫자 4~20자"
                    class="regist-input id" v-model="user.id"></md-outlined-text-field>
                ...
                <md-outlined-text-field label="이름" type="text" class="regist-input name" v-model="user.name"></md-outlined-text-field>
                <md-outlined-text-field label="비밀번호" type="password" placeholder="영문+숫자 8~20자"
                    class="regist-input pw" v-model="user.pw"></md-outlined-text-field>
                <md-outlined-text-field label="비밀번호 확인" type="password"
                    class="regist-input pwCheck" v-model="user.pwCheck"></md-outlined-text-field>
                ...
                <div class="birth-box">
                    <md-outlined-text-field label="생년월일" placeholder="YYYYMMDD ex) 19990101"
                        class="regist-input birth" v-model="user.birth"></md-outlined-text-field>
                </div>
            </div>
